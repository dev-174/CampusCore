      ...
      <div className="flex-between" style={{ marginBottom: '1.5rem' }}>
        <div>
          ...
          <p className="page-sub">
            Assign which faculty teaches which subject to which batch. The same
            subject can have a different faculty per batch (e.g. DM taught to
            A1 by one faculty, and to A3 by another).
          </p>
        </div>
              ...
              <tr>
                <td colSpan={6}>
                  <div className="empty">
                    ...
                    <p>No teaching assignments yet. Create one to get started.</p>
                  </div>
                </td>
              </tr>
            ) : assignments.map((a, i) => (
        ...
        <form onSubmit={handleAdd}>
          ...
          <div className="form-group">
            ...
            >
              ...
              {subjectsInDept.map(s => <option key={s.id} value={s.id}>{s.name} ({s.code})</option>)}
            </select>
          ...
          <div className="form-group">
            ...
            >
              ...
              {facultyInDept.map(f => <option key={f.id} value={f.id}>{f.name}</option>)}
            </select>
