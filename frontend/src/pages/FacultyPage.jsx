...
export default function FacultyPage() {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      const serverMsg = e.response?.data?.detail || e.response?.data?.error || 'Failed to delete faculty.';
      setError(serverMsg);
      setDeleteTarget(null);
    } finally {
      setDeleting(false);
      ...
      <Modal isOpen={showAdd} onClose={() => setShowAdd(false)} title="Add Faculty">
        <form onSubmit={handleAdd}>
          ...
          <div className="form-group">
            ...
            <input className="form-input" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} placeholder="Dr. Ananya Sharma" />
          </div>
          <div className="form-group">
            <label className="form-label">Email</label>
            <input className="form-input" type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} placeholder="ananya.sharma@university.edu" />
          </div>
          <div className="form-group">
