  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (tab === 'join') {
        ...
        // Step 2: Set the password and activate account
      ...
      <div className="auth-left-panel">
        ...
        <div className="auth-left-footer">
          <div className="auth-glass-testimonial">
            ...
            <div className="auth-glass-testimonial-author">Dean Sarah Jenkins &bull; Engineering</div>
          </div>
        </div>
      </div>
              ...
              <div className="form-group">
                ...
                <div className="password-input-wrapper">
                  ...
                  >
                    {showPassword ? (
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.97 9.97 0 011.563-3.029m5.858-.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88L3 3m18 18l-7-7-7-7" />
                      </svg>
                    ) : (
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
