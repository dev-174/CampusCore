...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['enrollment_number', 'roll_no']
...
class FacultySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'email', 'is_verified', 'employee_id', 'department', 'department_name', 'designation']
...
class StudentPreviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'email', 'is_verified', 'roll_no',
                  ...
                  'phone_number', 'profile_photo', 'admission_year', 'enrollment_number']
