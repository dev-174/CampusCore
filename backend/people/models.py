...
class StudentProfile(models.Model):
    ...
    # Year the student was admitted. Stored explicitly (never derived from
    # today's date) because it permanently seeds the 'YY' segment of the
    # enrollment number -- it must stay correct even if the student is
    # created or edited long after admission.
