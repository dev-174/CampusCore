...
def build_training_rows(university):
    ...
    This replaces the old design where the label was just a restatement of the
    same row's features (marks<50 or attendance<75) -> model was re-learning a
    rule instead of predicting anything new.
    """
